...
A lean, flexible file-change watcher, using OS X FSEvents.
...
<b>No frogs were harmed during development!</b>
...
==== Time for a simple example
  ...
  process do |files|
    execute("rake docs:regenerate && open -a Safari html/index.html") if files.delete("README.rdoc")
  end
