...
#   before do
#     Kicker.stubs(:execute)
#     @handler = Kicker::Recipes::Rails.new([])
#   end
#   
#   xit "should instantiate a new instance and call the #handle! method when called" do
#     files = %w{}
...
#     
#     Kicker.expects(:execute).with("ruby -r test/1_test.rb -r test/namespace/2_test.rb -e ''")
#     @handler.handle!
#     
